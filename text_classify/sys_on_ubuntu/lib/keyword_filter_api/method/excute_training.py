...
def run_cnn_train(app_config, train_data_record):
...
def run_cnn_retrain(app_config, train_data_record):
...
def excute_cnn_train(app_config,train_data_list):
     ...
     for train_data_record in train_data_list:
         ...
         checkpoint_path = model_dir + "/runs/checkpoints/checkpoint"
         vocab_path = os.path.join(model_dir, "vocab")
         if os.path.exists(checkpoint_path) and os.path.exists(vocab_path):
             run_cnn_retrain(app_config, train_data_record)
         else:
            run_cnn_train(app_config, train_data_record)
